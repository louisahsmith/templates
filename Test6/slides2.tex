...
\newcommand{\myInstitution}{\vspace{-12pt}\setnote{\textcolor{colororange}{$if(institution)$$institution$$endif$}}}
...
\bibliographystyle{$if(bibstyle)$$bibstyle$$endif$}
\bibliography{$for(bibliography)$$bibliography$$sep$,$endfor$}
\addtocounter{framenumber}{$if(bibpages)$$bibpages$$endif$}
\addtocounter{page}{$if(bibpages)$$bibpages$$endif$}
\end{frame}
$endif$
